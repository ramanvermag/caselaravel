            ...
            <section class="content">
                ...
                <div class="box">
                    <div class="box-header with-border">
                        <h3 class="box-title">Edit  <b>{{ str_limit($message->heading,30)}}</b></h3>
                        <div class="box-tools pull-right">
                            <!-- <span class="btn"><a href="{{ url('message') }}">Back to message</a></span> -->
                        </div>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="form-group">
                            ...
                            <a class="btn btn-default" href="{{url('message')}} ">Cancle</a>
                            {{ Form::close() }}
                        </div>
                        </div>
                    </div>
