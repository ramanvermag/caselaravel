...
<div class='col-lg-12'>
            ...
            <div class="col-md-12">
             ...
             {{ Form::model($user, array('route' => array('profile.update', $user->id), 'method' => 'PUT', 'enctype' =>'multipart/form-data')) }} 
            ...
            @endif
                ...
                <div class="col-md-12">
                    <div class="form-group">    
                        {{ Form::submit('Update Profile', array('class' => 'btn btn-primary', 'id' => 'create-user-account')) }}
                    </div>
                </div>
