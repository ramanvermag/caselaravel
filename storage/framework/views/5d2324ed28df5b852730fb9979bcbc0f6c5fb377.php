...
<head>
  ...
  <link rel="stylesheet" type="text/css" href="<?php echo e(asset('css/ownStyle.css')); ?>">
...
<div class="wrapper">
    ...
    <header class="main-header">
        ...
        <a href="<?php echo e(url('/')); ?>" class="logo">
          ...
          <span class="logo-lg"><b><?php echo e(config('app.name', 'Case law')); ?></b></span>
          <!-- <a class="navbar-brand" href="<?php echo e(url('/')); ?>"><?php echo e(config('app.name', 'Case law')); ?></a> -->
        </a>
              ...
              <div class="navbar-custom-menu">
                <ul class="nav navbar-nav">
                  ...
                  <li class="dropdown user user-menu">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                      <img src="<?php echo e(asset('user_profile_pics')); ?>/<?php echo e(Auth::user()->id); ?>/profile/image.png" class="user-image" alt="User Image">
                    ...
                    <ul class="dropdown-menu">
                      ...
                      <li class="user-header">
                        <img src="<?php echo e(asset('user_profile_pics')); ?>/<?php echo e(Auth::user()->id); ?>/profile/image.png" class="img-circle" alt="User Image">
              ...
              <ul class="sidebar-menu" data-widget="tree">
                ...
                <li class="treeview">
                  <a href="#">
                    ...
                    <span>Users</span>
                    <span class="pull-right-container">
                      <span class="label label-primary pull-right">100000000</span>
                    </span>
                  </a>
                  <ul class="treeview-menu">
                    <li><a href="<?php echo e(url('users/create')); ?>"><i class="fa fa-circle-o"></i> Add user</a></li>
                    <li><a href="<?php echo e(url('users')); ?>"><i class="fa fa-circle-o"></i> View users</a></li>
    ...
    <?php else: ?>
        ...
        <?php echo $__env->yieldContent('content-not-auth'); ?>
