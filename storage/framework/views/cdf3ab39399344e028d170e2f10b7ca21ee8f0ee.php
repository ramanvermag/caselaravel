...
<head>
    ...
    <title><?php echo e(config('app.name', 'Case Law')); ?> <?php echo $__env->yieldContent('title'); ?></title>
    ...
    <link rel="stylesheet" href="<?php echo e(asset('dist/css/skins/skin-purple.css')); ?>">
    <link rel="stylesheet" href="<?php echo e(asset('css/ownStyle.css')); ?>">
...
<body class="hold-transition skin-blue sidebar-mini">
    ...
    <div class="wrapper">
        ...
        <header class="main-header">
            <a href="<?php echo e(url('/')); ?>" class="logo"> <span class="logo-mini"><b>A</b>LT</span> <span class="logo-lg"><b>LatestCase</b>Law</span> </a>
                          ...
                          <small>Member since <?php 
                           ...
                           ?></small>
                                ...
                                <li class="user-footer">
                                    <div class="pull-left"> <a href="<?php echo e(url('profile')); ?>" class="btn btn-default btn-flat">Profile</a> </div>
        ...
        <aside class="main-sidebar">
            <section class="sidebar">
                ...
                <ul class="sidebar-menu" data-widget="tree">
                    ...
                    <li class="">
                        <a href="<?php echo e(url('/')); ?>"> <i class="fa fa-dashboard"></i> <span>Dashboard</span> <span class="pull-right-container"> <!-- <i class="fa fa-angle-left pull-right"></i>  --></span> </a>
                         <!--  -->
                         <!--  -->
                        <ul class="treeview-menu">
                            <li><a href="<?php echo e(url('/')); ?>"><i class="fa fa-circle-o"></i>Dashboard</a></li>
                        </ul>
                    </li>
                    <!--
                    ...
                    <li class="treeview">
                        ...
                        <ul class="treeview-menu">
                            <li><a href="<?php echo e(url('users/create')); ?>"><i class="fa fa-circle-o"></i> Add members</a></li>
                            <li><a href="<?php echo e(url('users')); ?>"><i class="fa fa-circle-o"></i> view members</a></li>
                    ...
                    <li class="treeview">
                        ...
                        <ul class="treeview-menu">
                            <li><a href="<?php echo e(url('permissions')); ?>"><i class="fa fa-circle-o"></i>View permissions</a></li>
                            <li><a href="<?php echo e(url('permissions/create')); ?>"><i class="fa fa-circle-o"></i>Create permission</a></li>
                    ...
                    <li class="treeview">
                        ...
                        <ul class="treeview-menu">
                            <li><a href="<?php echo e(url('caselaws/create')); ?>"><i class="fa fa-circle-o"></i>Add New Caselaw</a></li>
                            <li><a href="<?php echo e(url('caselaws')); ?>"><i class="fa fa-circle-o"></i>View Caselaws</a></li>
                        </ul>
                    </li>
                    ...
                    <li class="treeview">
                        ...
                        <ul class="treeview-menu">
                            <li><a href="<?php echo e(url('message/create')); ?>"><i class="fa fa-circle-o"></i>New message</a></li>
                            <li><a href="<?php echo e(url('message')); ?>"><i class="fa fa-circle-o"></i>View Messages</a></li>
                        </ul>
                    </li>
                    ...
                    <li class="treeview">
                        ...
                        <ul class="treeview-menu">
                            <li><a href="<?php echo e(url('roles')); ?>"><i class="fa fa-circle-o"></i>Add Role</a></li>
                            <li><a href="<?php echo e(url('roles')); ?>"><i class="fa fa-circle-o"></i>View Roles</a></li>
                        </ul>
                    </li>
                   
                    <li>
                       <a href="<?php echo e(url('baract')); ?>"><i class="fa fa-circle-o"></i>Bar Acts</a>
                    </li>
                    <li>
                       <a href="<?php echo e(url('chapter')); ?>"><i class="fa fa-circle-o"></i>Chapters</a>
                    </li>
                    <li>
                       <a href="<?php echo e(url('section')); ?>"><i class="fa fa-circle-o"></i>Section</a>
                    </li>
        ...
        <?php echo $__env->yieldContent('content-of-user'); ?>
    ...
    <div class="wrapper">
        ...
        <!-- content append acording to action start -->
        <?php echo $__env->yieldContent('content-of-guest'); ?>
        <!-- content append acording to action end -->
        <!-- Add the sidebar's background. This div must be placed immediately after the control sidebar -->
        <div class="control-sidebar-bg"></div>
    </div>
    ...
    <script src="<?php echo e(asset('js/fc.js')); ?>"></script>
