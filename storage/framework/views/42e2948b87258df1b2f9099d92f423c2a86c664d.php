...
<?php //print_r($user); ?>
            ...
            <div class="col-md-12">
             ...
             <?php echo e(Form::model($user, array('route' => array('users.update', $user->id), 'method' => 'PUT', 'enctype' =>'multipart/form-data'))); ?> 
            ...
            <?php endif; ?>
                ...
                <div class="col-md-12">
                    <div class="form-group">    
                        <?php echo e(Form::submit('Update User', array('class' => 'btn btn-primary', 'id' => 'create-user-account'))); ?>
